...
namespace MobileExpress.Manage
{
	public partial class AdminiList : System.Web.UI.Page
	{
		...
		{
			Administrators.DeleteById(CusId);
		}
		...
		protected void Saveadministrators(object sender, EventArgs e)
		{
			try
			{
				...
				System.Diagnostics.Debug.WriteLine($"נתונים שהתקבלו: CusId={hfAdminId?.Value}, FullName={FullName}, Phone={Phone}, Addres={Addres}, Uname={Uname},    Email={Email}");
